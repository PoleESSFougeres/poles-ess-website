...
Setting.contact_bloc_description = "Vous avez des questions ? Vous souhaitez mieux identifier ce qui existe sur le territoire ?" if Setting.contact_bloc_description.blank?
